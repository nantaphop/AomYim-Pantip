...
public class RipplePagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public RipplePagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public RipplePagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RipplePagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
